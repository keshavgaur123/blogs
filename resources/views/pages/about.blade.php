    ...
    <div class="container-fluid p-0">
        ...
        <div class="container mt-4">
            ...
            <p>
                ...
                <strong style="color:yellow; text-shadow:  5px 5px 5px black; font-size: 25px;">National Geographic Wild
                    (NGW)</strong>
                A worldwide wildlife and nature-focused television channel that showcases documentaries on animals,
                ecosystems, and conservation. It combines entertainment with education, often featuring high-quality
                cinematography and storytelling to raise awareness about the natural world. It operates under The Walt
                Disney Company in partnership with the National Geographic Society.
            </p>
        </div>
        ...
        {{-- <div class="table-responsive mt-4">
            <table class="table table-striped table-bordered w-75 mx-auto">
                ...
                <div class="table-responsive mt-5 shadow-lg ">
                    <table
                        class="table table-light text-black table-striped table-hover table-bordered border-3 border-warning w-75 mx-auto align-middle mt-1 mb-1 text-center">
                        <thead class="bg-warning text-dark text-uppercase">
                            <tr>
                                <th scope="col" class="py-3 fs-5 bg-black text-warning">Author</th>
                                <th scope="col" class="py-3 fs-5 bg-black text-warning">Details</th>
                            </tr>
                        </thead>
                        <tbody>
